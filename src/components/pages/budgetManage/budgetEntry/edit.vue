...
export default {
  ...
  mounted() {
    this.$nextTick(function() {
      this.depatName = this.$route.query.row.depatName;
      ...
      this.form = {
        ...
        budtypeId: this.$route.query.row.budtypeId,
        contype: this.$route.query.row.contype,
        startDate: this.$route.query.row.startDate,
        endDate: this.$route.query.row.endDate,
        curId: this.$route.query.row.curId,
        exrate: this.$route.query.row.exrate,
    ...
    submit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          this.loading = true;
          this.$axios
            .put("/concur/budget/budgetApply/edit", this.form)
            .then(res => {
              this.loading = false;
              if (res && res.success) {
