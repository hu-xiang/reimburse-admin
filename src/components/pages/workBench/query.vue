  ...
  <div class="budgetApply">
    <top-bar>
      ...
      >
        ...
        <el-table-column prop="approverName" label="审批人" show-overflow-tooltip></el-table-column>
        <el-table-column prop="appTime" label="审批时间" show-overflow-tooltip></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getList(bool) {
      ...
      this.$axios
        .get(
          `/concur/worktab/queryApproval/list?${this.$qs.stringify(
