  ...
  <div class="budget">
    ...
    <table-bar>
      <el-table slot="table" v-loading="loading" border stripe :data="list" style="width: 100%">
        ...
        <el-table-column prop="lamount" label="预算金额" show-overflow-tooltip></el-table-column>
        <el-table-column prop="budQuarter" label="季度" show-overflow-tooltip></el-table-column>
        <el-table-column prop="eveLavailable" label="出差预算金额" show-overflow-tooltip></el-table-column>
        <el-table-column prop="eveLreserve" label="出差预算余额" show-overflow-tooltip></el-table-column>
        <el-table-column prop="appLavailable" label="报销预算金额" show-overflow-tooltip></el-table-column>
        <el-table-column prop="appLreserve" label="报销预算余额" show-overflow-tooltip></el-table-column>
      </el-table>
      <el-pagination
        slot="page"
...
export default {
  ...
  methods: {
    ...
    selectSure1() {
      ...
      this.searchContent.deptId = this.selected1[0].id;
    },
    eventSearch1() {
    ...
    getList(bool) {
      ...
      this.$axios
        .get(
          `/concur/report/budgetEnfor/list?${this.$qs.stringify(
